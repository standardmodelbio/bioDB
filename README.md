...
| **[Monarch Initiative](https://monarchinitiative.org/)** — causal gene-to-disease, phenotype-to-disease | [`biodb.monarch`](src/biodb/monarch.py) | ✅ BioLink v3 REST (`query_entity`, `query_associations`, `query_gene_associations`) | ✅ TSV knowledge graphs (`get_gene_associations`, `read_causal_gene_to_disease_association`) |
